function [correct]= new_copula_org(classifier1,classifier2,no_test_data)
%%clear all;

root='./Probability/'; # Root Path where the probability values will be stored#
classifier1_test_benign=csvread([root,classifier1,'_','Original_test','_B.csv']);
classifier1_test_malignant=csvread([root,classifier1,'_','Original_test','_M.csv']);
classifier1_train_benign=csvread([root,classifier1,'_','Original_train','_B.csv']);
classifier1_train_malignant=csvread([root,classifier1,'_','Original_train','_M.csv']);

classifier2_test_benign=csvread([root,classifier2,'_','Original_test','_B.csv']);
classifier2_test_malignant=csvread([root,classifier2,'_','Original_test','_M.csv']);
classifier2_train_benign=csvread([root,classifier2,'_','Original_train','_B.csv']);
classifier2_train_malignant=csvread([root,classifier2,'_','Original_train','_M.csv']);
