function [correct]= new_copula_roi(classifier1,classifier2,classifier3,f,no_test_roi)
%%clear all;
%disp('------------------Copula_cal------------')
% Data={'roi','original'};model
data={'train','test'};
...
classifier1_test_benign=csvread([root,data{:,2},'_',classifier1,'_fold',num2str(f),'_B','.csv']);
classifier1_test_malignant=csvread([root,data{:,2},'_',classifier1,'_fold',num2str(f),'_M','.csv']);
classifier1_train_benign=csvread([root,data{:,1},'_',classifier1,'_fold',num2str(f),'_B','.csv']);
classifier1_train_malignant=csvread([root,data{:,1},'_',classifier1,'_fold',num2str(f),'_M','.csv']);
classifier2_test_benign=csvread([root,data{:,2},'_',classifier2,'_fold',num2str(f),'_B','.csv']);
classifier2_test_malignant=csvread([root,data{:,2},'_',classifier2,'_fold',num2str(f),'_M','.csv']);
classifier2_train_benign=csvread([root,data{:,1},'_',classifier2,'_fold',num2str(f),'_B','.csv']);
classifier2_train_malignant=csvread([root,data{:,1},'_',classifier2,'_fold',num2str(f),'_M','.csv']);
classifier3_test_benign=csvread([root,data{:,2},'_',classifier3,'_fold',num2str(f),'_B','.csv']);
classifier3_test_malignant=csvread([root,data{:,2},'_',classifier3,'_fold',num2str(f),'_M','.csv']);
classifier3_train_benign=csvread([root,data{:,1},'_',classifier3,'_fold',num2str(f),'_B','.csv']);
classifier3_train_malignant=csvread([root,data{:,1},'_',classifier3,'_fold',num2str(f),'_M','.csv']);
% root='/media/aritra/STORAGE1/soumyajyotiFNAC/Project_ROI/bestModel/final/probability_distribution/';
% classifier1_test=csvread([root,classifier1,'_',data{:,2},'.csv']);
% classifier2_test=csvread([root,classifier2,'_',data{:,2},'.csv']);
% classifier3_test=csvread([root,classifier3,'_',data{:,2},'.csv']);
% classifier1_train=csvread([root,classifier1,'_',data{:,1},'.csv']);
% classifier2_train=csvread([root,classifier2,'_',data{:,1},'.csv']);
% classifier3_train=csvread([root,classifier3,'_',data{:,1},'.csv']);
% classifier1_test_benign=classifier1_test(:,1);
% classifier1_test_malignant=classifier1_test(:,2);
% classifier2_test_benign=classifier2_test(:,1);
% classifier2_test_malignant=classifier2_test(:,2);
% classifier3_test_benign=classifier3_test(:,1);
% classifier3_test_malignant=classifier3_test(:,2);
% classifier1_train_benign=classifier1_train(:,1);
% classifier1_train_malignant=classifier1_train(:,2);
% classifier2_train_benign=classifier2_train(:,1);
% classifier2_train_malignant=classifier2_train(:,2);
% classifier3_train_benign=classifier3_train(:,1);
% classifier3_train_malignant=classifier3_train(:,2);
% classifier4_test_benign=classifier4_test(:,1);
% classifier4_test_malignant=classifier4_test(:,2);
% classifier4_train_benign=classifier4_train(:,1);
% classifier4_train_malignant=classifier4_train(:,2);
% classifier5_test_benign=classifier5_test(:,1);
% classifier5_test_malignant=classifier5_test(:,2);
% classifier5_train_benign=classifier5_train(:,1);
% classifier5_train_malignant=classifier5_train(:,2);
% classifier6_test_benign=classifier6_test(:,1);
% classifier6_test_malignant=classifier6_test(:,2);
% classifier6_train_benign=classifier6_train(:,1);
% classifier6_train_malignant=classifier6_train(:,2);
% classifier7_test_benign=classifier7_test(:,1);
% classifier7_test_malignant=classifier7_test(:,2);
% classifier7_train_benign=classifier7_train(:,1);
% classifier7_train_malignant=classifier7_train(:,2);
% classifier3_test_benign=classifier3_test(:,1);
% classifier3_test_malignant=classifier3_test(:,2);
% classifier3_train_benign=classifier3_train(:,1);
% classifier3_train_malignant=classifier3_train(:,2);
...
%     end
% end
% accuracy = (count/no_test_roi)*100
% 
end